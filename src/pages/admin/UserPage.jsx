        ...
        <div className="w-1/2 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 fixed z-[1] flex flex-col justify-center items-center bg-white rounded-md shadow-md border border-dark_green px-10 py-10">
          ...
          {manage === "view" ? null : (
            <button
              ...
              onClick={() =>
                manage === "add" ? addUser() : updateUser(idUser)
              }
            >
              {manage === "add"
                ? "Tambah"
              ...
              <tbody>
                ...
                {users.map((user) => (
                  <tr key={user.ID} className="border-b">
                    <td className="px-4 py-2">{user.name_user}</td>
                    <td className="px-4 py-2">{user.phone_user}</td>
                    <td className="px-4 py-2">{user.address_user}</td>
                    <td className="px-4 py-2">{user.password_user}</td>
                    <td className="px-4 py-2">{user.username_user}</td>
                    <td className="px-4 py-2">{user.email_user}</td>
